# Wiki repoistory for iDEC {year} | {team_name}
...
The wiki created from this repository is hosted at [idec{year}.github.io/{team_repo_name}](https://idec{year}.github.io/{team_repo_name}).
